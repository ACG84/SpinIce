...
def main(argv=None):
    ...
    r.add_argument("--loop-shape", default=None, choices=["bipolar", "unipolar", "return", "alternating", "leak"])
    ...
    r.add_argument("--bias-field", type=float, default=None, help="readout field (T) for --measure-at bias / leak")
